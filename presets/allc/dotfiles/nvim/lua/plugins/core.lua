return {
...

  {
    ...
    config = function()
      ...
      vim.api.nvim_set_hl(0, "TroubleNormal", { fg = p.text, bg = p.base })
      vim.api.nvim_set_hl(0, "TroubleNormalNC", { fg = p.text, bg = p.base })
      vim.api.nvim_set_hl(0, "TroubleText", { fg = p.text, bg = p.base })
      vim.api.nvim_set_hl(0, "TroubleIndent", { fg = p.subtle, bg = p.base })
      vim.api.nvim_set_hl(0, "TroublePos", { fg = p.subtle, bg = p.base })
      vim.api.nvim_set_hl(0, "TroubleCount", { fg = p.yellow, bg = p.base })
      vim.api.nvim_set_hl(0, "TroubleSource", { fg = p.subtle, bg = p.base })
      vim.api.nvim_set_hl(0, "TroubleFilename", { fg = p.blue, bg = p.base })
    end,
  },
}
