...
# PDE runtime/state paths. Keep logs and app runtime data out of repo symlinked config.
export PDE_STATE_HOME="${PDE_STATE_HOME:-$HOME/.local/state/pde}"
export PDE_CACHE_HOME="${PDE_CACHE_HOME:-$HOME/.cache/pde}"
mkdir -p "$PDE_STATE_HOME/nvim" "$PDE_CACHE_HOME" 2>/dev/null || true
export NVIM_LOG_FILE="${NVIM_LOG_FILE:-$PDE_STATE_HOME/nvim/nvim.log}"
